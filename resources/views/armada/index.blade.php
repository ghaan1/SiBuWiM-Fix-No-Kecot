            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data Armada</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row p-4">
                            <div class="col-12">
                                <table id="table-armada" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Jumlah Armada</th>
...
@section('modal')
<div class="modal fade" id="deleteArmadaModal" tabindex="-1" role="dialog" aria-labelledby="deleteArmadaModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteArmadaModalLabel">Konfirmasi Hapus Data</h5>
            ...
            <div class="modal-footer">
                ...
                <form id="form-delete-armada" class="m-1">
                    @csrf
...
<div class="modal fade" id="editArmadaModal" tabindex="-1" role="dialog" aria-labelledby="editArmadaModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<script src="{{ asset('js/armada.js')}}"></script>
@endsection
